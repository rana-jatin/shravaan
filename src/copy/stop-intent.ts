...
export const STOP_PHRASES: Record<LanguageCode, string[]> = {
  "en-IN": ["stop", "turn it off", "turn off", "switch it off", "shut it off", "enough", "that's enough", "quiet", "silence", "no more music", "stop the music"],
  "hi-IN": ["stop", "band karo", "band kar", "bandh karo", "bas", "bas karo", "ruko", "ruk jao", "chup", "gaana band", "music band", "bandh kar do"],
...
export const QUIETER_PHRASES: Record<LanguageCode, string[]> = {
  "en-IN": ["quieter", "lower", "turn it down", "turn down", "volume down", "too loud", "softer", "reduce the volume", "not so loud"],
  "hi-IN": ["dheere", "dheere karo", "aawaz kam", "awaz kam", "kam karo", "halka karo", "volume kam", "zor se mat", "bahut tez"],
...
export const LOUDER_PHRASES: Record<LanguageCode, string[]> = {
  "en-IN": ["louder", "turn it up", "turn up", "volume up", "too quiet", "can't hear", "cannot hear", "increase the volume", "speak up"],
  "hi-IN": ["tez karo", "zor se", "aawaz badhao", "awaz badhao", "badhao", "volume badhao", "sunai nahi", "tez"],
