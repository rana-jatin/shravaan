...
import { ToolRegistry } from "@sp-i/ai/tools/registry.ts";
import { BUILTIN_TOOLS } from "@sp-i/ai/tools/builtin.ts";
import { createGetWeather } from "@sp-i/ai/tools/weather.ts";
import { NEWS_CATEGORIES, createGetNews, type NewsCategory } from "@sp-i/ai/tools/news.ts";
import { createRecallMood } from "@sp-i/ai/tools/wellbeing.ts";
import { createPlayMusic } from "@sp-i/ai/tools/music.ts";
import { RadioCatalogue } from "@sp-i/ai/domain/radio-catalogue.ts";
import { SPEAKABLE } from "@sp-i/ai/domain/languages.ts";
import { pendingStopReview } from "@sp-i/ai/copy/stop-intent.ts";
